...
⚠️ 首次使用前，先用 skills_list 查看可用技能，再用 activate_skill 加载"深度思考方法论"。
...
- 约束有张力 → 直接处理，不要思考
- 用户给了明确指令（"改成X"、"加个角色叫Y"）→ 直接执行
- 简单查询、润色、闲聊、按技能执行 → 直接处理

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
⚠️ 核心原则
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
deep_thinking 只用于"设计"阶段，不用于"修改"或"反思"阶段。
设计完成后，进入执行阶段就绝不要再调 deep_thinking。
把执行当思考 = 用 deep_thinking 逃避直接写正文/改设定。`,
    parameters: {
      type: 'object',
      properties: {
        action: {
