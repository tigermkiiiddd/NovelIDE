...
const outlineSubAgentConfig: SubAgentConfig<TimelineInput, TimelineOutput> = {
...
outline_manageChapters({
  add: [
    { title: "觉醒之夜", summary: "...", volumeIndex: 1 },
    { title: "暗流涌动", summary: "...", volumeIndex: 1 }
  ]
})
\`\`\`
...
export async function runTimelineSubAgent(
  ...
  return runSubAgent(outlineSubAgentConfig, aiService, input, {}, onLog, signal);
}
